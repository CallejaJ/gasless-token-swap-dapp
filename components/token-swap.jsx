  ...
  const handleSwap = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `Swapped ${amount} ${fromToken} for ${estimatedOutput.toFixed(
          6
        )} ${toToken}`,
      });
    } catch (error) {
  ...
  return (
    <Card className='w-full'>
      <CardHeader>
        ...
        <CardDescription>
          Swap tokens without paying gas fees using Smart Accounts
        </CardDescription>
      </CardHeader>
      <CardContent>
      ...
      <CardFooter className='flex flex-col gap-4'>
        ...
        <div className='text-center text-sm text-muted-foreground'>
          Gas fees sponsored by Smart Accounts
        </div>
